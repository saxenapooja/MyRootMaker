...
MvaTree::Variables::Variables(const Muon& muon, const TauCand& OStau, const TauCand& SStau, const TLorentzVector& met, unsigned int njets30, int regions, bool case2):
  regions(regions), case2(case2)
{
  init(muon, OStau, SStau, met, njets30);
}

MvaTree::Variables::Variables(const Electron& electron, const TauCand& OStau, const TauCand& SStau, const TLorentzVector& met, unsigned int njets30, int regions, bool case2):
  regions(regions), case2(case2)
{
  init(electron, OStau, SStau, met, njets30);
}

void MvaTree::Variables::init(const TLorentzVector& lepton, const TauCand& OStau, const TauCand& SStau, const TLorentzVector& met, unsigned int njets30)
{
...
MvaTree::MvaTree(const FakeRateFunctions& fr, const char* name, const char* desc):
  fakeRateFuncs(fr)
{
...
void MvaTree::fill(const Variables& vars, double weight)
{
